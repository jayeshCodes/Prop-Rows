...
<div class="row register">
  <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
			...
			<form action="listProperty.php" method="post">
                <input type="text" class="form-control" placeholder="Property Title" name="property_title">
                <input type="text" class="form-control" placeholder="Property Details" name="property_details">
              ...
              <select name="availablility" class="form-control">
               ...
               <input type="number" class="form-control" placeholder="Bed Room" name="bed_room">
               <input type="number" class="form-control" placeholder="Living Room" name="liv_room">
               <input type="number" class="form-control" placeholder="Parking" name="parking">
               <input type="number" class="form-control" placeholder="Kitchen" name="kitchen">
              ...
              <input type="text" class="form-control" placeholder="Floor Space" name="floor_space">
				<textarea rows="6" class="form-control" placeholder="Utility " name="utility"></textarea>
                <textarea rows="6" class="form-control" placeholder="Property Address" name="property_address"></textarea>
      <button type="submit" class="btn btn-success" name="Submit">Add Listing</button>
