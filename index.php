...
<!-- Header Starts -->
<div class="header">
<a href="index.php"><img src="images/pngegg.png " alt=" SLNP Realestate" width=10%></a>
        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Pune, India</p>
            ...
            <div class="col-lg-3 col-sm-3">
             ...
             <div class="col-lg-3 col-sm-3">
                    ...
                    <p><b>Prop Rows</b><br>
                      ...
                      <span class="glyphicon glyphicon-envelope"></span> ankitfirke@gmail.com <br><span class="glyphicon glyphicon-envelope"></span> jaygajbhar@gmail.com<br>
    ...
    <div class="modal-content">
      <div class="row">
        ...
        <div class="form-group">
          ...
          <input type="email" name="agent_email" class="form-control" id="exampleInputEmail2" placeholder="Enter email">
        </div>
        <div class="form-group">
